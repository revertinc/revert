                    ...
                    case TP_ID.bitbucket: {
                        ...
                        if (parsedFields && parsedFields.collection_type === 'groups') {
                            ...
                            const groups = await axios({
                                method: 'get',
                                url: `https://api.bitbucket.org/1.0/groups/${parsedFields.workspace}/${pagingString}`,
                                headers: {
                                    Authorization: `Bearer ${thirdPartyToken}`,
                                    Accept: 'application/json',
                                    'Content-Type': 'application/json',
                            ...
                            result = groups.data.values;
                        } else if (parsedFields && parsedFields.collection_type === 'repositories') {
                            const projects = await axios({
                                method: 'get',
                                url: `https://api.bitbucket.org/2.0/repositories/${pagingString}`,
                                headers: {
                                    Accept: 'application/json',
                                    Authorization: `Bearer ${thirdPartyToken}`,
                                },
