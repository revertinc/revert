...
import { SignedIn, SignedOut, SignUp, ClerkProvider, useUser } from '@clerk/clerk-react';
...
const App = () => {
    ...
    const setCurrentWorkflowId = useAppStore((state) => state.setCurrentWorkflowId);
    const { initGraph } = useStore();
    const setCurrentWorkflowName = useAppStore((state) => state.setCurrentWorkflowName);
    const setCurrentWorkflowData = useAppStore((state) => state.setCurrentWorkflowData);
    ...
    const isSameWorkspace = useMemo(() => {
        return currentWorkflowData === undefined || currentWorkflowData?.workspaceId === workspaceId;
