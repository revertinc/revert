...
const createCloseButton = function () {
  let svgCloseElement = document.createElementNS(
  ...
  let svgCloseElementPath = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "path"
  );
...
const createPoweredByBanner = function (self) {
  ...
  var poweredBySpan3 = createViewElement(
    "span",
      ...
      if (!integrationId) {
        ...
        for (let index = 0; index < this.integrations.length; index++) {
          ...
          let integrationConnectBlock = createIntegrationBlock(
            this,
            integration,
            index === this.integrations.length - 1
              ? "33px"
              : "33px 33px 0px 33px"
          );
