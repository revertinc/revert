...
<Cards center>
    ...
    <Card title="Node/TS" icon="fa-brands fa-node" href="https://www.npmjs.com/package/@revertdotdev/node" />
    <Card title="Python" icon="fa-brands fa-python" href="https://pypi.org/project/revert-api/" />
</Cards>
