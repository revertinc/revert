...
To establish the connection with one of the app,watch this video of ClickUp integration [ClickUp Integration](https://www.loom.com/share/1d8947425bcc49af89f210555a50f441?sid=51ad2d45-514a-4536-ac62-772a069cb4a7).
...
**5.** Execute the command `yarn workspace @revertdotdev/backend migration:dev` to apply the necessary database migrations.Also run this to seed the new changes to db tables `yarn workspace @revertdotdev/backend dev`.
